...
const Checkout = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 mt-20 md:p-6 bg-gray-50 min-h-screen">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6">
                ...
                <div className="mt-6 flex justify-between">
                  <button
                    onClick={handleBack}
                    className="px-6 cursor-pointer py-2 text-gray-600 hover:text-gray-800"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className={`px-6 cursor-pointer py-2 rounded-lg transition-colors ${
                      selectedAddress
