  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {featuredProducts.map((product) => (
        <div
          key={product.name}
          className="bg-white rounded-lg shadow-sm overflow-hidden group flex flex-col items-center md:w-[300px]"
        >
          ...
          <div className="p-4">
            ...
            <div className="ml-1 text-[14px] text-gray-500 line-through">
              {product.actualprice}
            </div>
            <button
              onClick={() => {
