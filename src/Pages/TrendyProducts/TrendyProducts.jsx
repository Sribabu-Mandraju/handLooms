  ...
  return (
    <div className='flex flex-col items-center lg:px-[100px]'>
        ...
        <div className="tabs flex gap-[10px] lg:gap-[20px]  bg-white/90 backdrop-blur-lg border-[2px] border-gray-200 rounded-lg">
            <div onClick={()=>setActiveTab("NewArrivals")} className={`cursor-pointer p-2  border-b-0 border-gray-300 ${activeTab === "NewArrivals" ? "bg-gray-500":""}`
            }>New Arrivals</div>
            <div onClick={()=>setActiveTab("BestSellers")} className={`cursor-pointer p-2  border-b-0 border-gray-300 ${activeTab === "BestSellers" ? "bg-gray-500":""}`}>BestSellers</div>
            <div onClick={()=>setActiveTab("Onsale")} className={`cursor-pointer p-2  border-b-0 border-gray-300 ${activeTab === "Onsale" ? "bg-gray-500":""}`}>Onsale</div>
        </div>
