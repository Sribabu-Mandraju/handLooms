  ...
  return (
    <div className="flex flex-col justify-center items-center gap-6">
      ...
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 text-lg font-medium">
        <div className="grid grid-cols-2   lg:grid-cols-5 gap-1 md:gap-4">
          {data.map((item, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div
                className="w-full h-[200px] overflow-hidden rounded-xl mb-4"
              ...
              <p className="text-sm text-gray-700 px-2 mb-1">
                {item.description}
              </p>
