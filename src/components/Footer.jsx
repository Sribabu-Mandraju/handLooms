            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div className="text-center md:text-left">
                    ...
                    <div className="flex justify-center md:justify-start gap-4 mt-4">
                        ...
                        <a href="#"><img src={playStore} alt="Play Store" className="h-10" /></a>
                    </div>
                </div>
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-gray-600 text-sm mt-2">
                        The Andhra Pradesh State Handloom Weavers’ Cooperative Society Limited. APCO Bhavan, 29-11-9/1, 
                        Venkateswara Rao Road, Near Rahman Park, Governorpet, VIJAYAWADA-520002
                    </p>
                    <p className="text-gray-600 text-sm mt-3">
                        Mon to Sat – 9 am till 6 pm<br />
                        9502774125
                    </p>
                    ...
                    <ul className="text-gray-800 text-sm mt-4 space-y-3">
                        {["About Us", "Order Tracking", "Store Locator", "Blogs", "Contact Us"].map((item, index) => (
                            <li key={index} className="relative group">
                                <a href="#" className="relative inline-block transition duration-300 text-gray-700 group-hover:text-gray-900">
                                    {item}
